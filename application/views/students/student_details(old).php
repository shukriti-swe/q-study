                    ...
                    <div class="row">
                        ...
                        <form class="form-horizontal" id="student_details">			
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8" style="padding-top: 8px;"> 
                              <?php foreach ($student_course as $row){echo $row['courseName'].',';} ?>
                            </div>							
                          </div>
                      ...
                      <div class="col-md-3 bottom10">
                        <ul class="setting_ul">
                          <li>
                            <a href="#">
                             <img src="assets/images/menu_n1.png">
                           </a>
                         </li>
                         <li>
                          <a onclick="upDateStudentProfile();">
                           <img src="assets/images/menu_n2.png">
                         </a>
                       </li>	
                     </ul>
                   </div>
  ...
  function upDateStudentProfile() {
    ...
    $.ajax({
      ...
      success: function (msg) {
        if (msg == 0) {
          $('#success').html('');
          $('#error').html('Password and confirm password must be same also password length minimum 6 characters');
        } else {
          $('#error').html('');
