...
<div class="ss_student_board">
    ...
    <?php if ($module_type == 1) { ?>
      <a href="all_tutors_by_type/<?php echo $index_user_id;?>/<?php echo $index_moduleType; ?>" style="display: inline-block;">Index</a>
    <?php } else {?>
      <!-- <a >Index</a> -->
    <?php }?>
...
//    $('#answer_matching').click(function () {
    ...
    function commonCall() {
        ...
        var present_order = "<?= $this->uri->segment('3'); ?>";
