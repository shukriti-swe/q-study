  ...
  <div class="ss_s_b_main" style="min-height: 100vh">
        ...
        <div class="col-md-8" style="border: 1px solid #c3c3c3;padding: 5px;position:relative;">
            ...
            <?php if($question_description['image_type_one']==1){?>
              ...
              <?=strip_tags($question_description['question'])?></p>
               <div style="text-align: center;">
                   <div style="border:7px solid #c3c3c3;min-height:200px;margin-top:15px;width: 80%;margin: 8% 10% 10% 10%;" class="type1_box1_image">
            ...
            <?php }else if($question_description['image_type_two']==1){?>
              ...
              <?=strip_tags($question_description['question'])?></p>
               <div style="text-align: center;">
                   <div style="min-height:200px;margin-top:15px;width: 100%;margin: 10% 0% 0% 0%;" class="type1_box1_image">
            ...
            <?php }else if($question_description['image_type_three']==1){?>
              ...
              <?=strip_tags($question_description['question'])?></p>
               <div style="text-align: center;">
                   <div style="min-height:700px;margin-top:15px;width: 100%;margin: 10% 0% 0% 0%;" class="type1_box1_image">
