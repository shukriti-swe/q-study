    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="color_list">
          <div class="color_choose" <?php if($question_description['title_color']=='#ffff00;'){echo 'style="border: 1px solid red;"';}?>>
            <input type="radio" class="color_input" name="title_color" value="#ffff00;" <?php if($question_description['title_color']=='#ffff00;'){echo "checked";}?>>
            <div class="color_set" style="background-color: #ffff00;"></div>
          </div>
          <div class="color_choose" <?php if($question_description['title_color']=='#0f0;'){echo 'style="border: 1px solid red;"';}?>>
            <input type="radio" class="color_input" name="title_color" value="#0f0;" <?php if($question_description['title_color']=='#0f0;'){echo "checked";}?>>
            <div class="color_set" style="background-color: #0f0;"></div>
          </div>
          <div class="color_choose" <?php if($question_description['title_color']=='#0ff;'){echo 'style="border: 1px solid red;"';}?>>
            <input type="radio" class="color_input" name="title_color" value="#0ff;" <?php if($question_description['title_color']=='#0ff;'){echo "checked";}?>>
            <div class="color_set" style="background-color: #0ff;"></div>
          </div>
          <div class="color_choose" <?php if($question_description['title_color']=='#f0f;'){echo 'style="border: 1px solid red;"';}?>>
            <input type="radio" class="color_input" name="title_color" value="#f0f;" <?php if($question_description['title_color']=='#f0f;'){echo "checked";}?>>
            <div class="color_set" style="background-color: #f0f;"></div>
          </div>
          <div class="color_choose" <?php if($question_description['title_color']=='#00f;'){echo 'style="border: 1px solid red;"';}?>>
            <input type="radio" class="color_input" name="title_color" value="#00f;" <?php if($question_description['title_color']=='#00f;'){echo "checked";}?>>
            <div class="color_set" style="background-color: #00f;"></div>
          </div>

        </div>
        <div class="color_list">
          <div class="color_choose" <?php if($question_description['title_color']=='#f00;'){echo 'style="border: 1px solid red;"';}?>>
            <input type="radio" class="color_input" name="title_color" value="#f00;" <?php if($question_description['title_color']=='#f00;'){echo "checked";}?>>
            <div class="color_set" style="background-color: #f00;"></div>
          </div>
          <div class="color_choose" <?php if($question_description['title_color']=='#ffc90e;'){echo 'style="border: 1px solid red;"';}?>>
            <input type="radio" class="color_input" name="title_color" value="#ffc90e;" <?php if($question_description['title_color']=='#ffc90e;'){echo "checked";}?>>
            <div class="color_set" style="background-color: #ffc90e;"></div>
          </div>
          <div class="color_choose" <?php if($question_description['title_color']=='#c8bfe7;'){echo 'style="border: 1px solid red;"';}?>>
            <input type="radio" class="color_input" name="title_color" value="#c8bfe7;" <?php if($question_description['title_color']=='#c8bfe7;'){echo "checked";}?>>
            <div class="color_set" style="background-color: #c8bfe7;"></div>
          </div>
          <div class="color_choose" <?php if($question_description['title_color']=='#b5e61d;'){echo 'style="border: 1px solid red;"';}?>>
            <input type="radio" class="color_input" name="title_color" value="#b5e61d;" <?php if($question_description['title_color']=='#b5e61d;'){echo "checked";}?>>
            <div class="color_set" style="background-color: #b5e61d;"></div>
          </div>
          <div class="color_choose" <?php if($question_description['title_color']=='#22b14c;'){echo 'style="border: 1px solid red;"';}?>>
            <input type="radio" class="color_input" name="title_color" value="#22b14c;" <?php if($question_description['title_color']=='#22b14c;'){echo "checked";}?>>
