...
<div class="row" id="first_section">
  <div class="col-sm-2">
    ...
    <input type="hidden" id="text_three_hint_no" name="text_three_hint_no" value="<?php if(!empty($question_description['text_three_hint_no'])){echo $question_description['text_three_hint_no'];}?>">
    <input type="hidden" id="text_four_hint_no" name="text_four_hint_no" value="<?php if(!empty($question_description['text_four_hint_no'])){echo $question_description['text_four_hint_no'];}?>">
    ...
    <input type="hidden" id="text_three_hint_color" name="text_three_hint_color" value="<?php if(!empty($question_description['text_three_hint_color'])){echo $question_description['text_three_hint_color'];}?>">
    <input type="hidden" id="text_four_hint_color" name="text_four_hint_color" value="<?php if(!empty($question_description['text_four_hint_color'])){echo $question_description['text_four_hint_color'];}?>">
    ...
    <div id="all_option_input">
      <?php 
      if(!empty($question_description['options'])){
...
<div class="row" id="second_section" style="display: none;">
  ...
  <div class="hint_ans_box col-sm-8">
   ...
   <div class="set_color_section">
        <div class="set_color_show_one" style="margin-right: 0px;">
          <div class="selected_color_one" data-id="1">
            <?php if(!empty($question_description['text_one_hint_color'])){ ?>
                <div class="selected_color_set one_color_added" data-id="1" style="display:flex;gap:5px;margin-bottom:5px;padding:2px;border:1px solid #c3c3c3;">
                    <div class="hint_color_list">
                    <div class="hint_chosen_color">
                        <input type="radio" class="hint_color_input take_input_color" data-id="1" name="title_color" value="<?=$question_description['text_one_hint_color']?>">
                        <div class="hint_color_set" style="background-color: <?=$question_description['text_one_hint_color']?>;">
                        </div>
                        </div> 
                    </div>
                    <img class="add_hint_question hint_text_change" data-id="1" src="assets/images/images/question_write.png">
                    <a class="clear_hint_by clear_hint1" data-id="1" type="button" style="text-decoration: underline;">clear</a>
                </div>
          ...
          <div class="selected_color_two" data-id="2">
            <?php if(!empty($question_description['text_two_hint_color'])){ ?>
                <div class="selected_color_set two_color_added" data-id="2" style="display:flex;gap:5px;margin-bottom:5px;padding:2px;border:1px solid #c3c3c3;">
                    <div class="hint_color_list">
                    <div class="hint_chosen_color">
                        <input type="radio" class="hint_color_input take_input_color" data-id="2" name="title_color" value="<?=$question_description['text_two_hint_color']?>">
                        <div class="hint_color_set" style="background-color: <?=$question_description['text_two_hint_color']?>">
                        </div>
                        </div>
                    </div>
                    <img class="add_hint_question hint_text_change" data-id="2" src="assets/images/images/question_write.png">
                    <a class="clear_hint_by clear_hint2" data-id="2" type="button" style="text-decoration: underline;">clear</a>
                </div>
        ...
        <div class="set_color_show_two" style="margin-right: 10px;">
          ...
          <?php if(!empty($question_description['text_three_hint_color'])){ ?>
            <div class="selected_color_set three_color_added" data-id="3" style="display:flex;gap:5px;border:1px solid #c3c3c3;margin-bottom:5px;padding:2px;">
               <div class="hint_color_list">
                <div class="hint_chosen_color">
                    <input type="radio" class="hint_color_input take_input_color" data-id="3" name="title_color" value="<?=$question_description['text_three_hint_color']?>">
                    <div class="hint_color_set" style="background-color: <?=$question_description['text_three_hint_color']?>">
                    </div>
                </div>
               </div>
              <img class="add_hint_question hint_text_change" data-id="3" src="assets/images/images/question_write.png"><a class="clear_hint_by clear_hint3" data-id="3" type="button" style="text-decoration: underline;">clear</a>
            </div>
          <?php  } ?>
          </div>

          <div class="selected_color_four" data-id="4">
          <?php if(!empty($question_description['text_four_hint_color'])){ ?>
            <div class="selected_color_set four_color_added" data-id="4" style="display:flex;gap:5px;border:1px solid #c3c3c3;margin-bottom:5px;padding:2px;">
                <div class="hint_color_list">
                    <div class="hint_chosen_color">
                        <input type="radio" class="hint_color_input take_input_color" data-id="4" name="title_color" value="<?=$question_description['text_four_hint_color']?>">
                        <div class="hint_color_set" style="background-color: <?=$question_description['text_four_hint_color']?>">
                        </div>
                    </div>
                </div>
                <img class="add_hint_question hint_text_change" data-id="4" src="assets/images/images/question_write.png"><a class="clear_hint_by clear_hint4" data-id="4" type="button" style="text-decoration: underline;margin-right:5px;">clear</a>
            </div>
          <?php  } ?>
          </div>
        </div>
       ...
       <div>
         ...
         <a id="add_note">Hint<img style="height:20px;width:20px;" class="light_image" src="assets/images/images/light.png"></a>
       </div>
   </div>
   ...
   <div id="word_remake" style="display:none;"></div>
  </div>
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <br>
        <textarea class="form-control question_description" name="com_question"><?php  if(!empty($question_info[0]['questionName'])){ echo $question_info[0]['questionName'];}?></textarea>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn_blue " data-dismiss="modal">Close</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" id="option_inputs">
        ...
        <?php $i= 1; if(!empty($question_description['options'])){  foreach($question_description['options'] as $option){ ?>
          <br><textarea class="form-control option_all option_description<?=$i?>"  name="options[]"><?=$option?></textarea>
        <?php $i++;} }else{?>
          <textarea class="form-control option_all option_description<?=$i?>"  name="options[]"></textarea>
          <?php }?>
      ...
      <div class="modal-footer option_footer">
        ...
        <?php $i= 1; if(!empty($question_description['options'])){ foreach($question_description['options'] as $option){ ?>
          <button type="button" data-id="<?=$i?>" class="btn btn_blue optionSaveButton saveComOption<?=$i?>">Save</button>
        <?php $i++;} }else{?>
          <button type="button" data-id="<?=$i?>" class="btn btn_blue optionSaveButton saveComOption<?=$i?>">Save</button>
          <?php }?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <br>
        <textarea class="form-control question_description" name="first_hint"><?=$question_description['first_hint']?></textarea>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn_blue " data-dismiss="modal">Close</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <br>
        <textarea class="form-control question_description" name="second_hint"><?=$question_description['second_hint']?></textarea>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn_blue " data-dismiss="modal">Close</button>
        <button type="button" class="btn btn_blue " data-dismiss="modal">Save</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <br>
        <textarea class="form-control question_description" name="third_hint"><?=$question_description['third_hint']?></textarea>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn_blue" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn_blue" data-dismiss="modal">Save</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <br>
        <textarea class="form-control question_description" name="four_hint"><?=$question_description['four_hint']?></textarea>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn_blue " data-dismiss="modal">Close</button>
        <button type="button" class="btn btn_blue" data-dismiss="modal">Save</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body hint_text_modal_body">
        ...
        <?php $i= 1; foreach($question_description['hint_text'] as $hint_text){ ?>
         <textarea class="form-control hint_textarea hint_textarea_no<?=$i?>" data-id="<?=$i?>" name="hint_text[]"><?=$hint_text?></textarea>
        <?php $i++; }?>
      ...
      <div class="modal-footer hint_text_modal_footer">
        ...
        <?php $i= 1; foreach($question_description['hint_text'] as $hint_text){ ?>
            <button type="button" class="btn btn_blue hint_save_button hint_save_button_no<?=$i?>" data-dismiss="modal" data-id ="<?=$i?>">Save</button>
        <?php $i++; }?>
      </div>
    </div>
  </div>
...
<div class="modal fade ss_modal ew_ss_modal" id="add_note_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn_blue " data-dismiss="modal">Close</button>
        <button type="button" class="btn btn_blue noteSaveModal">Save</button>
      </div>
    </div>
  </div>
</div>
  ...
  $(document).ready(function() {
    ...
    $(document).on('click', '.com_hint_image', function() {
      ...
      if(wrrite_input != ''){
        $('#second_section').show();
        $('#first_section').hide();
        $('#word_remake').html(wrrite_input);

        
        $("#word_remake p").each(function(){
           paragraphs.push($(this).html());
        });
        
        var get_sentences =  paragraphs;
        ...
        <?php if(!empty($question_description['text_one_hint_color'])){ ?>
            if(index==1){
                var color ='<?=$question_description['text_one_hint_color']?>';
                addCss = 'style="background-color:'+color+'"';
            }
        <?php } if(!empty($question_description['text_two_hint_color'])){ ?>
            if(index==2){
                var color ='<?=$question_description['text_two_hint_color']?>';
                addCss = 'style="background-color:'+color+'"';
            }
        <?php } if(!empty($question_description['text_three_hint_color'])){ ?>
            if(index==3){
                var color ='<?=$question_description['text_three_hint_color']?>';
                addCss = 'style="background-color:'+color+'"';
            }
        <?php } if(!empty($question_description['text_four_hint_color'])){ ?>
            if(index==4){
               var color ='<?=$question_description['text_four_hint_color']?>';
               addCss = 'style="background-color:'+color+'"';
            }
        <?php }?>

          all_answer += '<h6 '+addCss+' class="grammer_answer grammer_ans'+index+'" data-id="'+index+'" data-color_no ="'+index+'">'+get_sentence+'</h6>';
          ...
          if($(this).is(':checked')){
            ...
            $('.grammer_answer').each(function(){
              ...
              if(chk_color_no == get_id ){
                ...
                get_text_color_id = $(this).attr('data-color_no');
                get_text_color = $(this).attr('data-color');
                get_option_no = $(this).attr('data-id');
              }
            });
    ...
    $(document).on('click', '.clear_hint_by', function() {
      // var hint_no = $(this).attr('data-id');

      // $('.grammer_answer').each(function(){ 
      //   var chk_one_status = $(this).attr('data-color_no');
      //     if(chk_one_status != '' && chk_one_status==hint_no){
