                ...
                <div class="panel-body" >
                    <div class="form-group">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input class="form-control" type="number" name="numOfCols" value="<?php echo $numOfCols?>" id="tcolumns_number" min="1">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputncl3" class="col-sm-7 control-label">Number of rows</label>
                            <div class="col-sm-5">
                                <input class="form-control" type="number" name="numOfRows" value="<?php echo $numOfRows?>" id="trows_number" min="1">
                            </div>
                        </div>
                        <br/>
