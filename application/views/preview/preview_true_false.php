                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                            <div class="panel-body" id="quesBody">
                                <div class="math_plus" aftab="">
                                    <textarea class="mytextareaQuestion" name="questionName" disabled><?php echo $question_info_s[0]['questionName']; ?></textarea>
                                </div>
                            </div>
                                        ...
                                        <div class=" ss_module_result">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <td>
                                                        <a  class="text-center" onclick="showModalDes(<?php echo $i; ?>);"><img src="assets/images/icon_details.png"></a>
