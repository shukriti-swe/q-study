                ...
                <div class="col-sm-4">
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                        <div class="panel panel-default">
                            ...
                            <div id="quesBody"  class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                <textarea  class="mytextarea" name="questionName"><?php echo ($question_info_vcabulary->questionName); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="image_box_list ss_m_qu">
                                            ...
                                            foreach ($question_info_vcabulary->vocubulary_image as $row) {
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-2">
                                                        <p class="ss_lette">
                                                            <input type="radio" name="answer_reply" value="<?php echo $i; ?>" style="min-height: 97px;">
                                                        </p>
                                                    </div>
                                                </div>
                                                <?php
