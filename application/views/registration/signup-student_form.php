...
<div class="container ss_reg_form">
        <div class="row">
            ...
            <p id='form_error'></p>
                ...
                <div class="form-group">
                    ...
                    <p id="error_parent" style="color:red"></p>
                </div>
                <div class="form-group">
        ...
        <?php for ($i = 3; $i <= 12; $i++) {?>
                    ...
                    <div class="form-group">
                        <label>School/Corporate/Tutor Link</label>
                        <input class="form-control" type="text" id="" name="SCT[]"/>
 ...
 $('#btnSave').click(function(e){
    ...
    for (i=1; i<=students.length; i++){
        if($("#student_"+i).val()){
            ...
            $('#error_'+i).html('Student name is required');
            j=1;
            e.preventDefault();
        }
    }
    ...
    if(parent_name == ''){
        k=1;
        $('#error_parent').html('Parent name is required');
        e.preventDefault();
    } else {
        k=0;
        $('#error_parent').html('');
    ...
    $('#parent_otp_check').click(function(){
        ...
        $.ajax({
            ...
            success: function(msg){
                if(msg==3){
                    window.location.href = pathname+"signup_direct_deposit";
                }else if(msg==1 || msg==2){
                    window.location.href = pathname+"signup-paypal";
                }else if(msg==0){
