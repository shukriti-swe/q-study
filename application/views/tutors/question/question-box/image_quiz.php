...
<input type="hidden" name="image_type_one" id="image_type_one" value="0">
<input type="hidden" name="image_type_two" id="image_type_two" value="0">
<input type="hidden" name="image_type_three" id="image_type_three" value="0">

<input type="hidden" name="box_one_image" id="box_one_image" value="">
<input type="hidden" name="box_two_image" id="box_two_image" value="">
<input type="hidden" name="box_three_image" id="box_three_image" value="">

<input type="hidden" name="hint_one_image" id="hint_one_image" value="">
<input type="hidden" name="hint_two_image" id="hint_two_image" value="">
<input type="hidden" name="hint_three_image" id="hint_three_image" value="">
...
<div class="row" id="first_section">
  ...
  <div class="col-sm-11">
    <div class="Image_quiz_main">
      ...
      <div id="show_types" style="display:none;margin-left:20px;">
        <div class="form-group" style="float: left;margin-right: 10px;">
            <button type="button" class="btn btn-select type_one">Type-1</button>
        </div>

        <div class="form-group" style="float: left;margin-right: 10px;">
            <button type="button" class="btn btn-select type_two">Type-2</button>
        </div>

        <div class="form-group" style="float: left;margin-right: 10px;">
            <button type="button" class="btn btn-select type_three" >Type-3</button>
        </div>
      </div>
  ...
  <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
      <div class="panel panel-default">
          ...
          <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
              <textarea class="imageQuiztextarea" id="" name="question"></textarea>
          </div>
  ...
  <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
      <div class="panel panel-default">
          ...
          <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
              <textarea class="imageQuiztextarea" id="" name="quiz_explaination"></textarea>
          </div>
          <div class="modal-footer" style="background-color:white;">
  ...
  <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
      <div class="panel panel-default">
          ...
          <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
              <textarea class="form-control question_description imageQuiztextarea"  name="quiz_question"></textarea>
          </div>
          <div class="modal-footer" style="background-color:white;">
  ...
  <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
      <div class="panel panel-default">
          ...
          <div id="option_inputs" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
              <!-- <textarea class="imageQuiztextarea" id="" name="quiz_question"></textarea> -->
          </div>
    ...
    <!-- <div class="col-sm-6" style="position: absolute;left: 25%;z-index: 3;" id="type_one_titles">
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
        <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="headingOne" style="background-color:#00a2e8">
                <h5 class="panel-title">
...
<!-- ============ Type One start Here =============  -->
<div class="image_quiz_first_section" style="margin-top:10px;display:none;">
      ...
      <div style="border:1px solid #c3c3c3;width: 100px;padding:0px 5px;" class="type_one_second_box">
          <div style="position:relative;display:flex;gap:10px;padding-top:8px;">
            ...
            <label class="custom_radio">
              ...
              <input type="checkbox" class="radio_ans" value="1" name="help_check_one" data-id="12">
...
<div class="image_quiz_second_section" style="margin-top:10px;display:none;">
    ...
    <div class="col-sm-11" style="display:flex;gap:10px;">
      ...
      <div style="border:1px solid #c3c3c3;width: 100px;padding:0px 5px;" class="type_two_second_box">
          <div style="position:relative;display:flex;gap:10px;padding-top:8px;">
            ...
            <label class="custom_radio">
              <span class="all_options"></span>
              <input type="checkbox" class="radio_ans" value="1" name="help_check_two" data-id="22">
              <span class="checkmark "></span>
            </label>
          </div>
  ...
  <div class="row">
    ...
    <div class="col-sm-8 type_two_image_box">
      <div class="t2_box_one">
          <div style="border:7px solid #c3c3c3;min-height:400px;margin-top:15px" class="type2_box1_image">
          </div>
      </div> 
    </div>
    ...
    <div class="col-sm-8 type_two_hint_box" style="display:none;">
      <div class="t2_box_two">
          ...
          <div style="border:7px solid #c3c3c3;min-height:400px;margin-top:15px" class="type2_image_hint">
...
<div class="image_quiz_third_section" style="margin-top:10px;display:none;">
  <div class="row">
    <div class="col-sm-1">
    </div>
    <div class="col-sm-11" style="display:flex;gap:10px;">
      ...
      <div style="border:1px solid #c3c3c3;width: 100px;padding:0px 5px;" class="type_three_second_box">
          <div style="position:relative;display:flex;gap:10px;padding-top:8px;">
            ...
            <label class="custom_radio">
              <span class="all_options"></span>
              <input type="checkbox" class="radio_ans" value="1" name="help_check_three" data-id="32">
              <span class="checkmark "></span>
            </label>
          </div>
  ...
  <div class="row">
    ...
    <div class="col-sm-7 type_three_image_box">
       <div class="t3_box_one">
        <div>
          <div style="border:7px solid #c3c3c3;min-height:700px;margin-top:15px;margin-bottom:10px" class="type3_box1_image">
          </div>
        </div>
       </div> 
    </div>

    <div class="col-sm-7 type_three_hint_box" style="display:none;">
      <div class="t3_box_two">
          <div style="border:7px solid #c3c3c3;min-height:700px;margin-top:15px;margin-bottom:10px" class="type3_image_hint">
          </div>
      </div>
    </div>
...
<!-- <div class="modal fade ss_modal ew_ss_modal" id="quiz_question_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn_blue saveQuizQuestion">Save</button>
      </div>
    </div>
  </div>
</div> -->
...
<!-- <div class="modal fade ss_modal ew_ss_modal" id="t1_box1_question_description" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel"> Question Description </h4>
      ...
      <div class="modal-body">
        <textarea class="form-control imageQuiztextarea" name="question"></textarea>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn_blue " data-dismiss="modal">Close</button>
        <button type="button" class="btn btn_blue  t1_box1_ques_desc_modal_save">Save</button>
      </div>
    </div>
  </div>
</div> -->
...
<!-- 
<div class="modal fade ss_modal ew_ss_modal" id="t1_explainationModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel"> Question Description </h4>
      ...
      <div class="modal-body">
        <br>
        <textarea class="form-control imageQuiztextarea" name="quiz_explaination"></textarea>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn_blue " data-dismiss="modal">Close</button>
        <button type="button" class="btn btn_blue saveExplaination">Save</button>
      </div>
    </div>
  </div>
</div> -->
...
<script type="text/javascript">
  $(document).ready(function() {
    $( "#type_one_title" ).draggable();
    $( "#type_explaination" ).draggable();
    $( "#quiz_question_area" ).draggable();    
    $( "#options_area" ).draggable();

    $('#total_options').prop('readonly',true);
    //  Type one is start here
    ...
    $('.type_one').click(function(){
        $('#total_options').prop('readonly',false);
    ...
    $('#total_options').change(function() {
      ...
      for(var j=1;j<=total_number;j++){
        ...
        option_input += '<br><div class="optionDivs optionTextarea'+j+'"><textarea class="form-control option_all imageQuiztextarea option_description' + j + '"  name="options[]" id="imageCkeditor'+j+'"></textarea></div>';
      ...
      // CKEDITOR.replaceClass('imageQuiztextarea');
      // CKEDITOR.replace('.imageQuiztextarea', {
    ...
    $(document).on('click', '.quiz_option_image', function() {
      ...
      $('.option_all').each(function(e,item){
          var x= 'imageCkeditor'+(e+1);
          //$('.optionTextarea' + (e+1)).show();
          if($('#'+x).length){
            console.log(x);
            var chkEditor = CKEDITOR.instances[x];
            if(!chkEditor){
            CKEDITOR.replace( x, { customConfig: '<?= base_url()?>assets/ckeditor/custom_config.js',  toolbar: [
    ...
    $('#options_modal').on('shown.bs.modal', function () {
      //alert('<?//= base_url()?>assets/ckeditor/custom_config.js');
      $('.option_all').each(function(e,item){
