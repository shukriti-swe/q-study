                ...
                <div class="panel-body ss_imag_add_right">
                    ...
                    <div class="image_box_list ss_m_qu">
                        ...
                        <div class="row editor_hide" id="list_box_<?php echo $i;?>" style="">
                            ...
                            <div class="col-xs-1">
                                <p class="ss_lette">
                                    <input type="checkbox" name="response_answer[]" value="<?php echo $i?>" style="min-height: 158px;">
                                </p>
                            </div>
                        </div>
                        <?php }?>
                    ...
                    <div class="row editor_hide" id="list_box_<?php echo $desired_i?>" style="display:none;">
                        ...
                        <div class="col-xs-1">  
                            <p class="ss_lette">
                                <input type="checkbox" name="response_answer[]" value="<?php echo $desired_i;?>" style="min-height: 158px;">
                            </p>
                        </div>
                    </div>
                    <?php } ?> 
