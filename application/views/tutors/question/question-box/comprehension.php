...
<div class="row" id="first_section">
  <div class="col-sm-2">
    ...
    <input type="hidden" id="com_hint_type" name="com_hint_type" value="">
...
<div class="row" id="second_section" style="display: none;">
  ...
  <div class="hint_ans_box col-sm-8">
        <div style="text-decoration:underline;color:black;display:flex;gap:10px;margin-left:25%;">
          <a class="sentence_select">Sentence</a>
          <a class="word_select">Word</a>
        </div>
   ...
   <div class="hint_selection_content_sentence">
   </div>
      ...
      <div class="modal-body">
        <div class="color_list">
          <div class="color_choose">
            <input type="radio" class="color_input" name="title_colors" value="#ffff00;">
            <div class="color_set" style="background-color: #ffff00;"></div>
          </div>
          <div class="color_choose">
            <input type="radio" class="color_input" name="title_colors" value="#0f0;">
            <div class="color_set" style="background-color: #0f0;"></div>
          </div>
          <div class="color_choose">
            <input type="radio" class="color_input" name="title_colors" value="#0ff;">
            <div class="color_set" style="background-color: #0ff;"></div>
          </div>
          <div class="color_choose">
            <input type="radio" class="color_input" name="title_colors" value="#f0f;">
            <div class="color_set" style="background-color: #f0f;"></div>
          </div>
          <div class="color_choose">
            <input type="radio" class="color_input" name="title_colors" value="#00f;">
        ...
        <div class="color_list">
          <div class="color_choose">
            <input type="radio" class="color_input" name="title_colors" value="#f00;">
            <div class="color_set" style="background-color: #f00;"></div>
          </div>
          <div class="color_choose">
            <input type="radio" class="color_input" name="title_colors" value="#ffc90e;">
            <div class="color_set" style="background-color: #ffc90e;"></div>
          </div>
          <div class="color_choose">
            <input type="radio" class="color_input" name="title_colors" value="#c8bfe7;">
            <div class="color_set" style="background-color: #c8bfe7;"></div>
          </div>
          <div class="color_choose">
            <input type="radio" class="color_input" name="title_colors" value="#b5e61d;">
            <div class="color_set" style="background-color: #b5e61d;"></div>
          </div>
          <div class="color_choose">
            <input type="radio" class="color_input" name="title_colors" value="#22b14c;">
...
<div class="modal fade ss_modal ew_ss_modal" id="hint_text_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel"> Question Description </h4>
      ...
      <div class="modal-body">
        <textarea class="form-control hint_text_one_textarea" name="hint_text_one_textarea"></textarea>
        <textarea class="form-control hint_text_two_textarea" name="hint_text_two_textarea"></textarea>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn_blue " data-dismiss="modal">Close</button>
        <button type="button" class="btn btn_blue secondtHintModalButton">Save</button>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $(document).on('click', '.hint_words', function() {
      ...
      if(chk_word != undefined){
        ...
        if(check_set != undefined){
         ...
         alert('Please select sentence or word !');
      }
    });
    ...
    $(document).on('click', '.hint_color_choose', function() {
      ...
      //   alert('hello');
      // }else if($('.hint_color_input_one').is(':checked')){
      //   alert('hello1');
      // }
