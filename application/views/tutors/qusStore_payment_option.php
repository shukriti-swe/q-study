...
$course_cost = $this->session->userdata('totalCost');
...
<div class="container ss_payment_form">
	 	<div class="row">
	 		<form  action="card_form_submit_qus_store" method="POST" id="paymentFrm">
			 	 <div class="col-sm-3"> </div>
			 	 <div class="col-sm-6">
					 <p class="payment-errors"></p>
			 	 	<div class="ss_payment_form_top">
			 	 		<a href="<?php echo base_url();?>go_paypal_qusStore"><img src="<?php echo base_url();?>assets/images/icon_paypal.jpg"> </a> <span>Click on the PayPal logo</span>
			 	 	</div>
			 	 	...
			 	 	<div class="ss_payment_form_agre" style="padding-left: 15px !important;padding: 1px;">
				    	<div class="row">
				    		...
				    		<?php if ($payment_process == 2): ?>
					    		<div class="col-md-9" style="background: #7092be;padding: 17px 30px;width: 72%;color: #fff">
					    			<p style="color: #fff">No direct debit</p>
                    				<p style="color: #fff">One time payment without no automatic renewel.</p>
					    		</div>
				    		<?php endif ?>
				    		<?php if ($payment_process == 3): ?>
					    		<div class="col-md-9" style="background: #7092be;padding: 29px 30px;width: 72%;color: #fff">
					    			<p style="color: #fff">Direct Deposit</p>
					    		</div>
				    		<?php endif ?>
				    	</div>
			 	 		<!-- <div class="checkbox">
			 	 ...
			 	 <div class="col-sm-3 ss_payment_right">
			 	 	<div class="imag"><a href="#"><img src="assets/images/money_back_garenty.jpg"></a></div>
			 	 	<div class="imag"><a href="#"><img src="assets/images/ssl_cicurary.jpg"></a></div>
	 	 	     </div>
	 	 </form>
	 </div>
	 </div>
