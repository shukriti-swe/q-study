        ...
        <div class="col-sm-8">
                  <?php 
                    ...
                    foreach($question_info as $question){
                        ...
                        $ans = '<p style="color:#fb8836;font-size:20px;">&nbsp;'.$student_ans[$i].'&nbsp;</p>';
                        
                        $questions_answer = $answer[$i];
                        $make_question = str_replace($questions_answer,$ans,$question);
                    ?>
                        <div style="font-weight: bold;font-size:20px;margin-left:20px;"><?=strip_tags($question_info_s[0]['question_instruction'])?></div>
                        <br><br>
