...
<div id="ss_enrollment_add_link"  class="modal fade ss_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      		<div class="row">
      		 <br/>
          <img src="assets/images/icon_info.png" class="pull-left"><span class="ss_extar_top20">See Your result in enrollment list</span> 	
		...
		$.ajax({
			...
			success: function(msg){
				...
				if(msg.length >0 ){
					...
					html += '<div class="form-group  row"><label for="inputPassword3" class="col-sm-6 control-label">ref. Link Number</label><div class="col-sm-6"> <input type="text" class="form-control" id="inputPassword3" value="'+msg[0]['SCT_link']+'" name="link[]"></div></div>';
				}
