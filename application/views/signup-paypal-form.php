...
if ($payment_process == 1) {
    ...
    $notify_url = "https://q-study.com/signup_paypal_notify";
    $payment = 'Subscribe';
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <form action="<?php echo $url;?>" method="post">
                ...
                <input type='hidden' name='return' value="<?php echo base_url();?>/parents">
                <input type='hidden' name='cancel_return' value="<?php echo base_url();?>/parents">
