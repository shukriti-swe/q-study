            ...
            <div class="row">
                ...
                <div class="ss_s_b_main" style="min-height: 100vh">
                    ...
                    <div class="col-sm-4" style="text-align: center;">
                        <div style="border: 1px solid #e1e3e5;">
                            <div class="math_plus">
                        ...
                        <div class="col-xs-12" style="text-align: center; margin-top: 5px;display: block;" >
                            <a class="btn btn_next" type="submit" id="answer_matching">Submit</a>
                        </div>
                    </div>
