...
if ($payment_process == 1) {
    ...
    $notify_url = "https://q-study.com/signup_upper_paypal_notify";
    $payment = 'Subscribe';
}elseif($payment_process == 2){
    $cmd = '_xclick';
    $notify_url = "https://q-study.com/signup_no_debit_paypal_notify";
    $payment = 'Payment';
}
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <form action="<?php echo $url;?>" method="post">
                ...
                <input type='hidden' name='return' value="<?php echo base_url();?>upper_level">
                <input type='hidden' name='cancel_return' value="<?php echo base_url();?>upper_level">
