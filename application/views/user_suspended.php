...
<body>
    <main role="main">   
        <section class="jumbotron text-center">
            <div class="container">
                <h1 class="jumbotron-heading">Acount Suspended</h1>
                <p class="lead text-muted">Your account is suspended! Please contact with admin</p>
            </div>
        </section>    
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                  <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        <p class="card-text">Your account is suspended! Please contact with admin</p>
