...
<?php echo $header_sign_up; ?>
			<div class="container ss_payment_form">
				 	<div class="row">
				 		...
				 		<form  action="signup_upper_card_form_submit" method="POST" id="paymentFrm">
						 	 <div class="col-sm-3"> </div>
						 	 <div class="col-sm-6">
								 <p class="payment-errors"></p>
						 	 	<div class="ss_payment_form_top">
						 	 		<a href="<?php echo base_url();?>signup_upper_go_paypal"><img src="<?php echo base_url();?>assets/images/icon_paypal.jpg"> </a> <span>Click on the PayPal logo</span>
						 	 	</div>
