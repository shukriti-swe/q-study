...
<form action="<?php echo base_url();?>tutor_file-upload" class="dropzone" id="upload-widget">
...
<script>
  ...
  init: function() {
	...
	this.on('error', function( file, resp ){    
	  $('#img_upload_msg').html('The image width minimum  640px and height minimum 480px');
    });
  ...
  accept: function(file, done) {
    ...
    done('The image width minimum  640px and height minimum 480px');
    };
  }
};
</script>