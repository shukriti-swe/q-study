                ...
                <!-- <div class="col-sm-2">
                    <form class="form-horizontal">
                        ...
                        <div class="form-group text-center">
                            ...
                            <button type="submit" class="btn btn-defult">Question</button> 
                            <button type="submit" class="btn btn-defult">Answare</button>
...
<!-- <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document" id="draggable">
